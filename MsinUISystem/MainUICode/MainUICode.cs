...
public class MainUICode : MyTransition
{
    ...
    private bool isSelectSave = false;
    private bool isSelectSetting = false;
    // get private att.
    public bool getIsSelectSave() { return this.isSelectSave; }
    public bool getIsSelectSetting() { return this.isSelectSetting; }
